...
1. Al cargar la pagina se presentaran las 4 funcionalidades del modulo
...
2. Al entrar a la función de recepciones se mostrara la tabla de guias de remisión de recepciones de recursos y/o productos.
...
|Imagen Interfaz|	![alt text](IMG4.png)|
