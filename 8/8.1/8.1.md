...
1. Al cargar la pagina se mostrará información del trabajo de la vacante a la que se postulará.

``` sql
select nombrepuesto, descripcionpuesto, area, ubicacion, tipocontrato, jornadalaboral, experiencia, niveleducativo, idiomas, habilidades, certificaciones, salario, bonos, beneficios, modalidad from vacante;
```
