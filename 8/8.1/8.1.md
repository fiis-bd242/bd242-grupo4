...
Boton Aprobado
```sql
UPDATE Registro_Verificacion_Estado
SET Estado = 'Aprobado'
FROM Registro_Verificacion
WHERE Registro_Verificacion_Estado.ID_registro_verificacion = Registro_Verificacion.ID_registro_verificacion
  AND Registro_Verificacion.ID_registro_verificacion = ?
  AND Registro_Verificacion_Estado.Estado != 'Aprobado';
...
WHERE Registro_Verificacion_Estado.ID_registro_verificacion = Registro_Verificacion.ID_registro_verificacion
  AND Registro_Verificacion.ID_registro_verificacion = ?
  AND Registro_Verificacion_Estado.Estado != 'No Aprobado';
...
```sql
SELECT
    r.Descripcion AS "Descripción del Recurso", 
    l.Cantidad_total AS "Cantidad del Lote", 
    l.ID_Lote AS "Lote", 
    r.Unidad AS "Unidad de Medida", 
    ie.Estado AS "Estado Inspección"
FROM
    Recurso r
JOIN
    Lote l ON r.ID_lote = l.ID_Lote
...
WHERE Inspeccion_Estado.ID_inspeccion = Inspeccion.ID_inspeccion
  AND Inspeccion.ID_inspeccion = ?
  AND Inspeccion_Estado.Estado = 'Rechazado';
```
