...
| 5 | Recepción de materiales | Los materiales son recibidos físicamente en el almacén, y el sistema actualiza el estado del pedido y la recepción. | Almacén |
| 6 | Verificación de documentos y control dimensional | Se validan los certificados de calidad, fichas técnicas del proveedor y se realiza el control dimensional de los materiales recibidos. | Calidad |
...
| 6.2 | Emisión automática de no conformidad | Si los materiales no cumplen con los requisitos, el sistema genera automáticamente una no conformidad y notifica al proveedor involucrado. | Calidad |
| 7 | Enviar materiales a producción | Después de ser aprobados los materiales, se envían inmediatamente a producción. | Almacén |
| 8 | Generación de notificación automática al área de producción | El sistema notifica automáticamente al área de producción el envío de los materiales con todos los detalles. | Almacén |
| 9 | Evaluación automática del rendimiento de proveedores | El sistema evalúa el rendimiento de los proveedores en base a tiempos de entrega, calidad de materiales y cantidad de no conformidades. | Logística |
