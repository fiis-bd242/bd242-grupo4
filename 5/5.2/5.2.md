...
|---|---|---|---|---|---|---|
|ID_Revision|	CHAR	|666666|	6 digitos	|-	|-|	Identificador único de la revisión técnica.|
|ID_Invitación	|CHAR	|666666	|6 digitos	|-|	-	|Identificador de la invitación relacionada.|
|ID_Empleado|	CHAR|	666666|	6 digitos|	-|	-|	Identificador del empleado.|
|ID_InformeStock|	CHAR	|666666|	6 digitos|	-|	-	|Identificador del informe del stock/materiales.|
...
| Atributo | Naturaleza | Formato | Valores válidos | Unidad | Derivada de | Descripción |
| --- | --- | --- | --- | --- | --- | --- |
| ID_Propuesta | CHAR | 666666 | 6 digitos | - | - | Identificador único de la propuesta. |
| ID_Cliente | CHAR | 666666 | 6 digitos | - | - | Identificador del cliente asociado. |
| ID_Empleado | CHAR | 666666 | 6 digitos | - | - | Identificador del empleado. |
