...
Entidad: Vacante
Semántica: Representa una oferta de trabajo creada por la empresa para la cual se puede postular. Contiene información sobre el puesto disponible, los requisitos y condiciones del empleo.
...
Semántica: Registro de la solicitud de un candidato para una vacante. Incluye información sobre el candidato, la vacante a la que aplica y el estado de su postulación.
...
Semántica: Persona que aplica a una vacante. Contiene los datos básicos de contacto de los posibles empleados, como nombre, correo y teléfono.
...
Semántica: Mensaje enviado a un candidato o administrador informando sobre algún evento o acción relevante en el proceso de reclutamiento.
