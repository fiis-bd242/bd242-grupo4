...
| Atributo                    | Naturaleza | Formato    | Valores Válidos | Unidad | Derivada de | Descripción                                       |
|-----------------------------|------------|------------|-----------------|--------|-------------|---------------------------------------------------|
| ID_cronograma               | CHAR       | 999999     | 6 dígitos       | ---    | ---         | Identificador único del cronograma de mantenimiento. |
| Estado                      | VARCHAR    | X(50)      | ---             | ---    | ---         | Estado del cronograma (Pendiente, Completado, etc.). |
| Fecha_inicio                | DATE       | YYYY-MM-DD | ---             | ---    | ---         | Fecha de inicio del cronograma.                   |
| Fecha_fin                   | DATE       | YYYY-MM-DD | ---             | ---    | ---         | Fecha de finalización del cronograma.             |
