...
('C001', 'Empresa Construcción S.A.', '12345678901', 'Av. Siempre Viva 123', '987654321', 'info@empresaconstruccion.com', 'Cliente Corporativo', '2023-01-01', 'Activo', 'Carlos Pérez', 'Construcción', '100001'),
('C002', 'Suministros Industriales', '23456789012', 'Calle de la Industria 456', '987123456', 'contacto@suministros.com', 'Cliente Corporativo', '2023-01-15', 'Activo', 'Ana López', 'Metalurgia', '100002'),
('C003', 'Proveedores Metálicos', '34567890123', 'Av. Metálica 789', '912345678', 'info@proveedoresmetalicos.com', 'Cliente Corporativo', '2023-01-20', 'Activo', 'Luis García', 'Metalurgia', '100003'),
('C004', 'Almacenamiento Ltda.', '45678901234', 'Calle Almacenamiento 111', '965432189', 'info@almacenamiento.com', 'Cliente Corporativo', '2023-02-01', 'Activo', 'María Martínez', 'Almacenamiento', '100004'),
('C005', 'Servicios de Construcción', '56789012345', 'Av. Constructor 222', '912345678', 'info@serviciosconstruccion.com', 'Cliente Corporativo', '2023-02-15', 'Activo', 'Jorge Sánchez', 'Construcción', '100005'),
('C006', 'Metalúrgica del Perú', '67890123456', 'Calle Metalurgia 333', '956789012', 'info@metalurgicaperu.com', 'Cliente Corporativo', '2023-03-01', 'Activo', 'Elena Torres', 'Metalurgia', '100006'),
('C007', 'Estructuras y Suministros', '78901234567', 'Av. Estructuras 444', '964321789', 'info@estructurassuministros.com', 'Cliente Corporativo', '2023-03-15', 'Activo', 'Juan Hernández', 'Construcción', '100007'),
('C008', 'Almacenes de Metales', '89012345678', 'Calle Metales 555', '987654321', 'info@almacenesdemetales.com', 'Cliente Corporativo', '2023-04-01', 'Activo', 'Carmen Jiménez', 'Almacenamiento', '100008'),
('C009', 'Servicios de Alquiler', '90123456789', 'Av. Alquiler 666', '987654321', 'info@serviciosalquiler.com', 'Cliente Corporativo', '2023-04-10', 'Activo', 'Sofía Ramírez', 'Construcción', '100009'),
('C010', 'Constructora Lima', '01234567890', 'Calle Lima 777', '912345678', 'info@constructoralima.com', 'Cliente Corporativo', '2023-04-15', 'Activo', 'Pedro Morales', 'Construcción', '100010');

INSERT INTO Informe_stock (ID_informe_stock, Mes_informe, Año_informe, Fecha_generacion, Cantidad_actual_recurso, Cantidad_actual_producto, Stock_inicial, Stock_final, Stock_real, Stock_teorico, Observaciones, Estado_informe, ID_empleado) 
VALUES
('IS001', 1, 2023, '2023-01-31', 500, 300, 400, 600, 450, 500, 'Inventario de enero', 'A', '100001'),
('IS002', 2, 2023, '2023-02-28', 550, 350, 450, 650, 480, 520, 'Inventario de febrero', 'A', '100002'),
('IS003', 3, 2023, '2023-03-31', 600, 400, 500, 700, 500, 550, 'Inventario de marzo', 'A', '100003'),
('IS004', 4, 2023, '2023-04-30', 650, 450, 550, 750, 520, 570, 'Inventario de abril', 'A', '100004'),
('IS005', 5, 2023, '2023-05-31', 700, 500, 600, 800, 540, 590, 'Inventario de mayo', 'A', '100005'),
('IS006', 6, 2023, '2023-06-30', 750, 550, 650, 850, 560, 610, 'Inventario de junio', 'A', '100006'),
('IS007', 7, 2023, '2023-07-31', 800, 600, 700, 900, 580, 630, 'Inventario de julio', 'A', '100007'),
('IS008', 8, 2023, '2023-08-31', 850, 650, 750, 950, 600, 650, 'Inventario de agosto', 'A', '100008'),
('IS009', 9, 2023, '2023-09-30', 900, 700, 800, 1000, 620, 670, 'Inventario de septiembre', 'A', '100009'),
('IS010', 10, 2023, '2023-10-31', 950, 750, 850, 1050, 640, 690, 'Inventario de octubre', 'A', '100010');
...
('OP001', '2023-01-02', '2023-01-05', '2023-01-10', '1', 'A', '100001'),
('OP002', '2023-01-15', '2023-01-20', '2023-01-25', '2', 'B', '100002'),
('OP003', '2023-02-01', '2023-02-05', '2023-02-10', '1', 'A', '100003'),
('OP004', '2023-02-15', '2023-02-20', '2023-02-25', '3', 'C', '100004'),
('OP005', '2023-03-01', '2023-03-05', '2023-03-10', '2', 'B', '100005'),
('OP006', '2023-03-20', '2023-03-25', '2023-03-30', '1', 'A', '100006'),
('OP007', '2023-04-01', '2023-04-05', '2023-04-10', '2', 'B', '100007'),
('OP008', '2023-04-10', '2023-04-15', '2023-04-20', '1', 'A', '100008'),
('OP009', '2023-04-15', '2023-04-20', '2023-04-25', '2', 'B', '100009'),
('OP010', '2023-05-01', '2023-05-05', '2023-05-10', '1', 'A', '100010');
...
('GR001', '1', 'Almacén Norte', '2023-01-01', '2023-01-02', '1', '1', 'DOC001', '100001'),
('GR002', '1', 'Almacén Sur', '2023-01-15', '2023-01-16', '1', '1', 'DOC002', '100002'),
('GR003', '1', 'Almacén Este', '2023-02-01', '2023-02-02', '2', '1', 'DOC003', '100003'),
('GR004', '2', 'Almacén Oeste', '2023-02-15', '2023-02-16', '2', '1', 'DOC004', '100004'),
('GR005', '2', 'Almacén Central', '2023-03-01', '2023-03-02', '1', '1', 'DOC005', '100005'),
('GR006', '1', 'Almacén Norte', '2023-03-20', '2023-03-21', '2', '1', 'DOC006', '100006'),
('GR007', '2', 'Almacén Sur', '2023-04-01', '2023-04-02', '1', '1', 'DOC007', '100007'),
('GR008', '1', 'Almacén Este', '2023-04-10', '2023-04-11', '2', '1', 'DOC008', '100008'),
('GR009', '1', 'Almacén Oeste', '2023-05-01', '2023-05-02', '1', '1', 'DOC009', '100009'),
('GR010', '2', 'Almacén Central', '2023-05-15', '2023-05-16', '2', '1', 'DOC010', '100010');
...
('P001', 'Tanque de Almacenamiento', 'Tanque de acero para almacenamiento de líquidos', '1', TRUE, 2000.00, 1500.00, 500.00, 3.00, 30, 'Disponible', '2023-01-01', 'OP001', 'GR001', 'C001', 'DO001', 'DG001'),
('P002', 'Puente Metálico', 'Puente metálico de gran resistencia', '1', TRUE, 50000.00, 35000.00, 1500.00, 12.00, 90, 'En producción', '2023-01-15', 'OP002', 'GR002', 'C002', 'DO002', 'DG002'),
('P003', 'Faja Transportadora', 'Sistema de transporte de materiales', '1', TRUE, 10000.00, 8000.00, 200.00, 2.00, 15, 'Disponible', '2023-01-20', 'OP003', 'GR003', 'C003', 'DO003', 'DG003'),
('P004', 'Estructura Metálica', 'Estructura metálica para edificios', '1', TRUE, 15000.00, 11000.00, 700.00, 7.00, 45, 'En producción', '2023-02-01', 'OP004', 'GR004', 'C004', 'DO004', 'DG004'),
('P005', 'Almacén Prefabricado', 'Almacén metálico prefabricado', '1', TRUE, 25000.00, 18000.00, 1000.00, 9.00, 60, 'Disponible', '2023-02-10', 'OP005', 'GR005', 'C005', 'DO005', 'DG005'),
('P006', 'Tubos HDPE', 'Tubos de polietileno de alta densidad', '2', TRUE, 2000.00, 1500.00, 300.00, 1.50, 20, 'En stock', '2023-02-15', 'OP006', 'GR006', 'C006', 'DO006', 'DG006'),
('P007', 'Grúa Móvil', 'Grúa móvil para construcción', '1', TRUE, 80000.00, 60000.00, 2000.00, 15.00, 120, 'En producción', '2023-03-01', 'OP007', 'GR007', 'C007', 'DO007', 'DG007'),
('P008', 'Plataforma Elevadora', 'Plataforma para elevar cargas', '1', TRUE, 12000.00, 9000.00, 400.00, 3.00, 30, 'Disponible', '2023-03-10', 'OP008', 'GR008', 'C008', 'DO008', 'DG008'),
('P009', 'Escalera Metálica', 'Escalera metálica de gran altura', '1', TRUE, 2500.00, 1800.00, 100.00, 1.00, 10, 'En stock', '2023-03-20', 'OP009', 'GR009', 'C009', 'DO009', 'DG009'),
('P010', 'Soporte Metálico', 'Soporte para estructuras metálicas', '1', TRUE, 500.00, 350.00, 50.00, 0.50, 5, 'En stock', '2023-04-01', 'OP010', 'GR010', 'C010', 'DO010', 'DG010');
