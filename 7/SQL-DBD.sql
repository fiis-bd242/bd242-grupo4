...
DROP SEQUENCE if exists seq_certificado_calidad;

DROP SEQUENCE if exists seq_control_composicion;

DROP SEQUENCE if exists seq_control_dimensional;

DROP SEQUENCE if exists seq_doc_no_conformidad;

DROP SEQUENCE if exists seq_doc_no_conformidad_estado;

DROP SEQUENCE if exists seq_doc_no_conformidad_tipo_accion_correctiva;

DROP SEQUENCE if exists seq_ficha_tecnica;

DROP SEQUENCE if exists seq_inspeccion;

DROP SEQUENCE if exists seq_inspeccion_estado;

DROP SEQUENCE if exists seq_inspeccion_modalidad;

DROP SEQUENCE if exists seq_lote;

DROP SEQUENCE if exists seq_registro_verificacion;

DROP SEQUENCE if exists seq_registro_verificacion_estado;

DROP SEQUENCE if exists seq_resultado_inspeccion;

DROP SEQUENCE if exists seq_resultado_inspeccion_estado_final;
...
DROP FUNCTION if exists generar_id_certificado_calidad();

DROP FUNCTION if exists generar_id_control_composicion();

DROP FUNCTION if exists generar_id_control_dimensional();

DROP FUNCTION if exists generar_id_doc_no_conformidad();

DROP FUNCTION if exists generar_id_doc_no_conformidad_estado();

DROP FUNCTION if exists generar_id_doc_no_conformidad_tipo_accion_correctiva();

DROP FUNCTION if exists generar_id_ficha_tecnica();

DROP FUNCTION if exists generar_id_inspeccion();

DROP FUNCTION if exists generar_id_inspeccion_estado();

DROP FUNCTION if exists generar_id_inspeccion_modalidad();

DROP FUNCTION if exists generar_id_lote();

DROP FUNCTION if exists generar_id_registro_verificacion();

DROP FUNCTION if exists generar_id_registro_verificacion_estado();

DROP FUNCTION if exists generar_id_resultado_inspeccion();

DROP FUNCTION if exists generar_id_resultado_inspeccion_estado_final();
